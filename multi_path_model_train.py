...
def data_gen(splited_npy_dataset_path):
    ...
    while True:
        ...
        for batch_path in batch_dirs:
            ...
            yield [flair_validation, t2_validation, t1_validation], Y_batch # for multi path res u-net
            # yield flair_validation, Y_batch # for classic res u-net
            # yield X_batch, Y_batch # for multi channel res u-net
...
def valid_data_gen(split_npy_dataset_path):
    ...
    while True:
        ...
        for batch_path in batch_dirs:
            ...
            yield [flair_validation, t2_validation, t1_validation], y_validation # for multi path res u-net
            # yield flair_validation, y_validation # for classic res u-net
            # yield X_validation, y_validation # for multi channel res u-net
...
if __name__ == '__main__':
    ...
    model = get_resnet_model(input_shape, n_classes)
    ...
    callbacks = [
        ModelCheckpoint("Model/multi_path_model.h5", verbose=1, save_best_model=True),
    ...
    plot_metrics('multi_path_model_graphs', history)
