...
if __name__ == '__main__':
    input_shape = (args.input_width, args.input_height, 3)
    epochs = args.epochs
    n_classes = 16
    lr = 1e-4
    ...
    callbacks = [
        ModelCheckpoint("Model/multi_channel_model.h5", verbose=1, save_best_model=True),
    ...
    plot_metrics('multi_channel_model_graphs', history)
